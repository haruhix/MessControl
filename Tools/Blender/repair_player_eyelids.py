...
left=set(range(len(adj))); repaired=[]; lid_bones=[]; body_remapped=0
while left:
...
obj['repair_notes']='Rigid eyelid weights, face weights isolated from lids, 0.8 cm shell clearance. Body/limb rig and UVs preserved.'
...
(folder/'FaceRepair.json').write_text(json.dumps({'source':'TeethFaceSource.fbx','eyelids':repaired,'body_vertices_remapped':body_remapped,
