...
`MI_CoffeeSurface` отвечает за внешний вид, `DA_CoffeeWater` — за волны и плавучесть, `DA_Day01` — за длительность события, течение и силу подгребания. Это следующий небольшой шаг существующего кофе, без изменения правил дня и моделей коллеги. [Настройки, управление и запись](CoffeeWater.md).
